...
?>
    ...
    <form method="post" action="../Controller/feedbackInsert.php">
    <table border="0" width = "100%" height = "100%">
            ...
            <td>
                ...
                <td align ="center">
                <h1 style="color:SeaGreen;"> <b> Feedback </b> </h1>
               
                        <textarea  name="feedback" rows="10" cols="60">Enter Your Feedback Here</textarea><br><br>
                                <input type="submit" name="submit" value="Submit Your Opinion" size="23"/>
