...
?>
    ...
    <form method="post" action="../Controller/gardeninsert.php">
    <table border="0" width = "100%" height = "100%">
            ...
            <td>
                ...
                <td align ="center">
                <h3 style="color:SeaGreen;"> Garden Registration  </h3>
                <table border="0" align ="center">
                <tr align ="left">
                ...
                <tr align ="left">
                    <td width="60%">  Tin-Number
                    </td>
                    <td>:
                    </td>
                    <td>
                     <input type="tel" name="tin" value=""><br>
                    </td>
                </tr>
